...
class InviteTeamMember implements InvitesTeamMembers
{
     ...
     */
    public function invite(Request $request, User $user, Team $team, string $email, ?string $role = null)
    {
        ...
        $result = app('App\Http\Controllers\TeamInvitationController')->accept($request, $invitation);
