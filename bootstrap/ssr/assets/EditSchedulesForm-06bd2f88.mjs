...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const scheduleFieldsVisible = ref(false);
    const form = useForm("editSchedules", {
      _method: "PUT",
      id: props.schedules.id,
      name: props.schedules.name,
      category: props.schedules.category,
      description: props.schedules.description,
      full_url: props.schedules.full_url,
      thumbnail: props.schedules.thumbnail,
      fields: props.schedules.fields,
      photo: null,
      manifest: null
    });
    const toggleFields = () => {
      scheduleFieldsVisible.value = !scheduleFieldsVisible.value;
    };
    ...
    const addField = () => {
      ...
      fieldCreateForm.post(route("schedule_fields.store"), {
    ...
    const updateSchedule = () => {
      ...
      if (form.name == "") {
        form.setError("name", "Schedule Name required.");
      ...
      if (props.formMode == "edit") {
        form.post(route("schedules.update"), {
          onError: () => form.focus(),
          onFinish: () => form.reset()
        });
      } else {
    ...
    const markScheduleErrors = (errorIds) => {
      errorIds.forEach((id) => {
        let element = document.getElementById(id);
        if (element !== null) {
          document.getElementById(id).className = "schedule-row-color-error";
        }
      });
    };
    router.on("success", () => {
      markScheduleErrors(scheduleErrorIds);
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        title: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div style="${ssrRenderStyle({ "width": "50%", "float": "left", "text-align": "left" })}"${_scopeId}><span${_scopeId}>Schedule:</span></div><div style="${ssrRenderStyle({ "width": "50%", "float": "left", "text-align": "right" })}"${_scopeId}>`);
        ...
        form: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<select id="category" name="category" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm schedule-fields-modal-category"${_scopeId}><option value="pedestrian"${_scopeId}> Pedestrian </option><option value="pedestrian_emergency"${_scopeId}> Pedestrian Emergency </option></select>`);
            _push2(ssrRenderComponent(_sfc_main$5, {
            ...
            if (_ctx.manifestUpload) {
              ...
              if (unref(form).full_url) {
                _push2(ssrRenderComponent(_sfc_main$6, {
                  type: "button",
                  class: "mt-2 schedule-fields-modal-thumb-btn",
            ...
            if (thumbnailPreview.value && !unref(form).thumbnail) {
              _push2(`<div${_scopeId}><span class="schedule-thumbnail-preview" style="${ssrRenderStyle("background-image: url('" + thumbnailPreview.value + "');")}"${_scopeId}></span></div>`);
            } else {
              _push2(`<div${_scopeId}><img class="schedule-thumbnail-image"${ssrRenderAttr("src", _ctx.$page.props.schedules.thumbnail_photo_url)} alt="schedule-thumbnail"${_scopeId}></div>`);
            }
            _push2(`</div></div>`);
          } else {
            return [
              ...
              createVNode("div", {
                ...
                createVNode("div", { class: "px-2" }, [
                  ...
                  withDirectives(createVNode("select", {
                    ...
                    name: "category",
                    class: "border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm schedule-fields-modal-category"
                  }, [
        ...
        actions: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="schedule-edit-form-actions"${_scopeId}><div class="schedule-edit-show-fields"${_scopeId}>`);
            ...
            _push2(`</div><div class="schedule-edit-form-buttons"${_scopeId}><a${ssrRenderAttr("href", _ctx.route("schedules.index"))}${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$6, {
              type: "button",
              class: "mr-2"
            }, {
            ...
            _push2(`</a>`);
            _push2(ssrRenderComponent(_sfc_main$2, { onClick: updateSchedule }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Save Schedule `);
                } else {
                  return [
                    createTextVNode(" Save Schedule ")
                  ];
                }
              }),
              _: 1
            ...
            return [
              createVNode("div", { class: "schedule-edit-form-actions" }, [
                createVNode("div", { class: "schedule-edit-show-fields" }, [
                ...
                createVNode("div", { class: "schedule-edit-form-buttons" }, [
                  createVNode("a", {
                  ...
                  createVNode(_sfc_main$2, { onClick: updateSchedule }, {
                    default: withCtx(() => [
                      createTextVNode(" Save Schedule ")
                    ]),
                    _: 1
      ...
      _push(ssrRenderComponent(_sfc_main$7, {
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="schedule-fields-modal-grid"${_scopeId}><div class="px-2"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$3, {
              for: "name",
              value: "Name"
            }, null, _parent2, _scopeId));
            ...
            _push2(`<select id="type" name="type" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm planners-edit-class-code-input schedule-field-select"${_scopeId}><option value="string"${_scopeId}> String </option><option value="integer"${_scopeId}> Integer </option><option value="font"${_scopeId}> Font </option><option value="picker"${_scopeId}> Color Picker </option><option value="select"${_scopeId}> Drop Down </option><option value="textarea"${_scopeId}> Text Box </option></select>`);
            _push2(ssrRenderComponent(_sfc_main$5, {
            ...
            return [
              createVNode("div", { class: "schedule-fields-modal-grid" }, [
                createVNode("div", { class: "px-2" }, [
                  createVNode(_sfc_main$3, {
                    for: "name",
                    value: "Name"
                ...
                createVNode("div", { class: "px-2" }, [
                  ...
                  withDirectives(createVNode("select", {
                    ...
                    name: "type",
                    class: "border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm planners-edit-class-code-input schedule-field-select"
                  }, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Schedules/Partials/EditSchedulesForm.vue");
