...
import _sfc_main$2 from "./EditSchedulesForm-06bd2f88.mjs";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({ title: "AirPortal JFK Terminal 4" }, _attrs), {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h2 class="font-semibold text-xl text-gray-800 leading-tight"${_scopeId}> AirPortal JFK Terminal 4 | ${ssrInterpolate(props.formMode === "add" ? "New Schedule" : "Modify Schedule")}</h2>`);
          } else {
            return [
              createVNode("h2", { class: "font-semibold text-xl text-gray-800 leading-tight" }, " AirPortal JFK Terminal 4 | " + toDisplayString(props.formMode === "add" ? "New Schedule" : "Modify Schedule"), 1)
            ];
          }
        }),
          ...
          if (_push2) {
            if (__props.canEditSchedules) {
              ...
              _push2(ssrRenderComponent(_sfc_main$2, {
                schedules: _ctx.$page.props.schedules,
                schedule: _ctx.$page.props.schedule,
                "can-edit-schedules": __props.canEditSchedules,
            ...
            return [
              __props.canEditSchedules ? (openBlock(), createBlock("div", { key: 0 }, [
                createVNode("div", { class: "max-w-7xl mx-auto py-10 sm:px-6 lg:px-8" }, [
                  createVNode(_sfc_main$2, {
                    ...
                    "can-edit-schedules": __props.canEditSchedules,
                    "form-mode": _ctx.$page.props.formMode
                  }, null, 8, ["schedules", "schedule", "can-edit-schedules", "form-mode"])
                ])
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Schedules/EditSchedules.vue");
