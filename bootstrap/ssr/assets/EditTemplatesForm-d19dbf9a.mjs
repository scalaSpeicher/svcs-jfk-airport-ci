...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const form = useForm("editTemplate", {
      _method: "PUT",
      id: props.templates.id,
      name: props.templates.name,
      category: props.templates.category,
      description: props.templates.description,
      full_url: props.templates.full_url,
      thumbnail: props.templates.thumbnail,
      fields: props.templates.fields,
      photo: null,
      manifest: null
    });
    const fieldCreateForm = useForm("fieldCreateForm", {
      template_id: props.templates.id,
      name: "",
      type: "string",
      label: "",
      required: "",
    ...
    const toggleFields = () => {
      templateFieldsVisible.value = !templateFieldsVisible.value;
    };
    ...
    const addField = () => {
      ...
      fieldCreateForm.post(route("template_fields.store"), {
    ...
    const updateTemplate = () => {
      ...
      if (form.name == "") {
        form.setError("name", "Template Name required.");
      ...
      if (props.formMode == "edit") {
        form.post(route("templates.update"), {
          onError: () => form.focus(),
          onFinish: () => form.reset()
        });
      } else {
    ...
    const markTemplateErrors = (errorIds) => {
      errorIds.forEach((id) => {
        let element = document.getElementById(id);
        if (element !== null) {
          document.getElementById(id).className = "template-row-color-error";
        }
      });
    };
    router.on("success", () => {
      markTemplateErrors(templateErrorIds);
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        title: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div style="${ssrRenderStyle({ "width": "50%", "float": "left", "text-align": "left" })}"${_scopeId}><span${_scopeId}>Template:</span></div><div style="${ssrRenderStyle({ "width": "50%", "float": "left", "text-align": "right" })}"${_scopeId}>`);
            ...
            return [
              createVNode("div", { style: { "width": "50%", "float": "left", "text-align": "left" } }, [
                createVNode("span", null, "Template:")
              ]),
        ...
        form: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<select id="category" name="category" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm template-fields-modal-category"${_scopeId}><option value="pedestrian"${_scopeId}> Pedestrian </option><option value="pedestrian_emergency"${_scopeId}> Pedestrian Emergency </option><option value="curbside"${_scopeId}> Curbside </option><option value="samples"${_scopeId}> Samples </option></select>`);
            _push2(ssrRenderComponent(_sfc_main$5, {
            ...
            if (__props.manifestUpload) {
              ...
              if (unref(form).full_url) {
                _push2(ssrRenderComponent(_sfc_main$6, {
                  type: "button",
                  class: "mt-2 template-fields-modal-thumb-btn",
            ...
            if (thumbnailPreview.value && !unref(form).thumbnail) {
              _push2(`<div${_scopeId}><span class="template-thumbnail-preview" style="${ssrRenderStyle("background-image: url('" + thumbnailPreview.value + "');")}"${_scopeId}></span></div>`);
            } else {
              _push2(`<div${_scopeId}><img class="template-thumbnail-image"${ssrRenderAttr("src", _ctx.$page.props.templates.thumbnail_photo_url)} alt="template-thumbnail"${_scopeId}></div>`);
            }
            _push2(`</div></div>`);
          } else {
            return [
              ...
              createVNode("div", {
                ...
                createVNode("div", { class: "px-2" }, [
                  ...
                  withDirectives(createVNode("select", {
                    ...
                    name: "category",
                    class: "border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm template-fields-modal-category"
                  }, [
                    createVNode("option", { value: "pedestrian" }, " Pedestrian "),
                    createVNode("option", { value: "pedestrian_emergency" }, " Pedestrian Emergency "),
                    createVNode("option", { value: "curbside" }, " Curbside "),
                    createVNode("option", { value: "samples" }, " Samples ")
                ...
                __props.manifestUpload ? (openBlock(), createBlock("div", {
                  key: 0,
                  class: "px-2"
                }, [
                  createVNode(_sfc_main$3, {
                ...
                __props.thumbnailUpload ? (openBlock(), createBlock("div", {
                  key: 2,
                  class: "px-2"
                }, [
        ...
        actions: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="template-edit-form-actions"${_scopeId}><div class="template-edit-show-fields"${_scopeId}>`);
            ...
            _push2(`</div><div class="template-edit-form-buttons"${_scopeId}><a${ssrRenderAttr("href", _ctx.route("templates.index"))}${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$6, {
              type: "button",
              class: "mr-2"
            }, {
            ...
            _push2(`</a>`);
            _push2(ssrRenderComponent(_sfc_main$2, { onClick: updateTemplate }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Save Template `);
                } else {
                  return [
                    createTextVNode(" Save Template ")
                  ];
                }
              }),
              _: 1
            ...
            return [
              createVNode("div", { class: "template-edit-form-actions" }, [
                createVNode("div", { class: "template-edit-show-fields" }, [
                ...
                createVNode("div", { class: "template-edit-form-buttons" }, [
                  createVNode("a", {
                  ...
                  createVNode(_sfc_main$2, { onClick: updateTemplate }, {
                    default: withCtx(() => [
                      createTextVNode(" Save Template ")
                    ]),
                    _: 1
      ...
      _push(ssrRenderComponent(_sfc_main$7, {
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="template-fields-modal-grid"${_scopeId}><div class="px-2"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$3, {
              for: "name",
              value: "Name"
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_sfc_main$4, {
              id: "name",
              modelValue: unref(fieldCreateForm).name,
              "onUpdate:modelValue": ($event) => unref(fieldCreateForm).name = $event,
              name: "name",
              type: "text",
              class: "block w-full"
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_sfc_main$5, {
              message: unref(fieldCreateForm).errors.name
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="px-2"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$3, {
              for: "type",
            ...
            _push2(`<select id="type" name="type" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm planners-edit-class-code-input template-field-select"${_scopeId}><option value="string"${_scopeId}> String </option><option value="integer"${_scopeId}> Integer </option><option value="font"${_scopeId}> Font </option><option value="picker"${_scopeId}> Color Picker </option><option value="select"${_scopeId}> Drop Down </option><option value="textarea"${_scopeId}> Text Box </option></select>`);
            _push2(ssrRenderComponent(_sfc_main$5, {
              message: unref(fieldCreateForm).errors.type
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="px-2"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$3, {
              for: "label",
            ...
            _push2(ssrRenderComponent(_sfc_main$4, {
              id: "label",
              modelValue: unref(fieldCreateForm).label,
              "onUpdate:modelValue": ($event) => unref(fieldCreateForm).label = $event,
              name: "label",
              type: "text",
              class: "block w-full"
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_sfc_main$5, {
              message: unref(fieldCreateForm).errors.label
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="px-2"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$3, {
              for: "default",
            ...
            _push2(ssrRenderComponent(_sfc_main$4, {
              id: "default",
              modelValue: unref(fieldCreateForm).default,
              "onUpdate:modelValue": ($event) => unref(fieldCreateForm).default = $event,
              name: "default",
              type: "text",
              class: "block w-full"
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_sfc_main$5, {
              message: unref(fieldCreateForm).errors.default
            }, null, _parent2, _scopeId));
            _push2(`</div><div style="${ssrRenderStyle(unref(fieldCreateForm).type == "string" || unref(fieldCreateForm).type == "integer" || unref(fieldCreateForm).type == "textarea" ? null : { display: "none" })}" class="px-2"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$3, {
              for: "max",
              value: "Max"
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_sfc_main$4, {
              id: "max",
              modelValue: unref(fieldCreateForm).max,
              "onUpdate:modelValue": ($event) => unref(fieldCreateForm).max = $event,
              name: "max",
              type: "text",
              class: "block w-full"
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_sfc_main$5, {
              message: unref(fieldCreateForm).errors.max
            }, null, _parent2, _scopeId));
            _push2(`</div><div style="${ssrRenderStyle(unref(fieldCreateForm).type == "string" || unref(fieldCreateForm).type == "integer" || unref(fieldCreateForm).type == "textarea" ? null : { display: "none" })}" class="px-2"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$3, {
              for: "min",
            ...
            _push2(ssrRenderComponent(_sfc_main$4, {
              id: "min",
              modelValue: unref(fieldCreateForm).min,
              "onUpdate:modelValue": ($event) => unref(fieldCreateForm).min = $event,
              name: "min",
              type: "text",
              class: "block w-full"
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_sfc_main$5, {
              message: unref(fieldCreateForm).errors.min
            }, null, _parent2, _scopeId));
            _push2(`</div><div style="${ssrRenderStyle(unref(fieldCreateForm).type == "string" || unref(fieldCreateForm).type == "integer" || unref(fieldCreateForm).type == "textarea" ? null : { display: "none" })}" class="px-2"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$3, {
              for: "lines",
            ...
            _push2(ssrRenderComponent(_sfc_main$4, {
              id: "lines",
              modelValue: unref(fieldCreateForm).lines,
              "onUpdate:modelValue": ($event) => unref(fieldCreateForm).lines = $event,
              name: "lines",
              type: "text",
              class: "block w-full"
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_sfc_main$5, {
              message: unref(fieldCreateForm).errors.lines
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="px-2"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$3, {
              for: "required",
            ...
            _push2(ssrRenderComponent(ToggleButton, {
              modelValue: unref(fieldCreateForm).required,
              "onUpdate:modelValue": ($event) => unref(fieldCreateForm).required = $event,
              onlabel: "Yes",
              offlabel: "No",
            ...
            return [
              createVNode("div", { class: "template-fields-modal-grid" }, [
                createVNode("div", { class: "px-2" }, [
                  createVNode(_sfc_main$3, {
                    for: "name",
                    value: "Name"
                ...
                createVNode("div", { class: "px-2" }, [
                  ...
                  withDirectives(createVNode("select", {
                    id: "type",
                    "onUpdate:modelValue": ($event) => unref(fieldCreateForm).type = $event,
                    name: "type",
                    class: "border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm planners-edit-class-code-input template-field-select"
                  }, [
                    ...
                    [vModelSelect, unref(fieldCreateForm).type]
                  ]),
                  createVNode(_sfc_main$5, {
                    message: unref(fieldCreateForm).errors.type
                  }, null, 8, ["message"])
                ...
                withDirectives(createVNode("div", { class: "px-2" }, [
                  ...
                  [vShow, unref(fieldCreateForm).type == "string" || unref(fieldCreateForm).type == "integer" || unref(fieldCreateForm).type == "textarea"]
                ]),
                withDirectives(createVNode("div", { class: "px-2" }, [
                  createVNode(_sfc_main$3, {
                    for: "min",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Templates/Partials/EditTemplatesForm.vue");
