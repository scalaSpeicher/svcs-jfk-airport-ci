...
<template>
    <div>
        <div v-if="$page.props.userData.canEditTeams">
            <SectionBorder />
            ...
            <FormSection @submitted="addTeamMember">
                ...
                <template #form>
                    ...
                    <div class="col-span-6 sm:col-span-4 mt-4">
                        ...
                        >
                            <option
                                v-for="user in $page.props.usersOptions"
                                :key="user.id"
                                :name="user.email"
                                :value="user.email"
                            >
                    ...
                    >
                        ...
                        <div class="relative z-0 mt-1 border border-gray-200 rounded-lg cursor-pointer">
                            <button
                                v-for="(role, i) in $page.props.availableRoles"
                                :key="role.key"
                                type="button"
                                ...
                                :class="{ 'border-t border-gray-200 focus:border-none rounded-t-none': i > 0, 'rounded-b-none': i != Object.keys($page.props.availableRoles).length - 1 }"
        ...
        <div v-if="team.team_invitations.length > 0 && $page.props.userData.canEditTeams">
            <SectionBorder />
        ...
        <div v-if="team.memberships.length > 0">
            <SectionBorder />
            ...
            <ActionSection class="mt-10 sm:mt-0">
                ...
                <template #content>
                    <div class="space-y-6">
                        <div
                            v-for="user in $page.props.team.memberships"
                            :key="user.id"
                            class="flex items-center justify-between"
                        >
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <Link
                                        ...
                                        :href="route('users.index', { _query: { search: user.email } })"
                                    >
                            ...
                            <div class="flex items-center">
                                ...
                                <button
                                    v-if="$page.props.availableRoles"
                                    v-show="$page.props.userData.canEditTeams && user.role != 'owner'"
                                ...
                                <!-- Leave Team -->
                                <button
                                    v-if="$page.props.auth.user.id === user.user_id"
                                ...
                                <!-- Remove Team Member -->
                                <button
                                    v-else-if="$page.props.userData.canEditTeams"
                                    v-show="$page.props.userData.canEditTeams && user.role != 'owner'"
                                    class="cursor-pointer ml-6 text-sm text-red-500"
        ...
        >
            <template #title>
                Manage Role | {{ updateRoleForm.name }} ({{ updateRoleForm.email }})
            </template>
                ...
                <div v-if="managingRoleFor">
                    <div class="relative z-0 mt-1 border border-gray-200 rounded-lg cursor-pointer">
                        <button
                            ...
                            class="relative px-4 py-3 inline-flex w-full rounded-lg focus:z-10 focus:outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500"
                            :class="{ 'border-t border-gray-200 focus:border-none rounded-t-none': i > 0, 'rounded-b-none': i !== Object.keys($page.props.availableRoles).length - 1 }"
                            @click="manageRoleSelectedRole(role)"
                        >
