...
<template>
    <FormSectionWide>
                ...
                >
                    ...
                    >
                        <img
                            ...
                            :src="$page.props.schedules.thumbnail_photo_url"
        ...
        <template #actions>
            <div class="schedule-edit-form-actions">
                <div class="schedule-edit-show-fields">
                    <PrimaryButton
                        v-if="canAddFields"
                        @click="toggleFields"
                    >
                ...
                <div class="schedule-edit-form-buttons">
                    <a
    ...
    <div
        v-show="scheduleFieldsVisible"
        class="schedule-fields-container"
    >
    ...
    >
        ...
        <template #content>
            <div class="schedule-fields-modal-grid">
                <div
                    class="px-2"
                >
                    <InputLabel
