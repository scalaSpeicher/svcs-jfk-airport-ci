                        ...
                        >
                            ...
                            >
                                <Checkbox
                                    ...
                                    :value="permission"
                                />
                                <span class="ml-2 text-sm text-gray-600 capitalize">{{ permission }}</span>
                            </label>
                        </div>
                    </div>
                </div>
        ...
        <div v-if="apiRoutes.length > 0">
            ...
            <div class="mt-10 sm:mt-0">
                <ActionSection>
                    ...
                    <template #description>
                        Currently, routes cannot be edited or deleted.
                    </template>
                            ...
                            >
                                ...
                                <div class="flex items-center ml-2">
                                    <div
                                        ...
                                        class="text-sm text-gray-400"
                                    >
                                        Last used {{ index }} days ago
                                    </div>

                                    <button
                                        v-if="canEditTokens"
                                        class="cursor-pointer ml-6 text-sm text-gray-400 underline"
                                        @click="manageApiEndpoint(item)"
                                    >
                                        Manage Endpoint
                                    </button>
                                </div>
