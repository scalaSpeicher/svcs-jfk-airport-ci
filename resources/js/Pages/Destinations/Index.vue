...
watch(search, Debounce(function (value) {
    router.get('/destinations', { search: value },
               {
                   // preserveState: true,
                   replace: true
               }
...
<template>
    <AppLayout title="AirPortal JFK Terminal 4">
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                AirPortal JFK Terminal 4&nbsp;|&nbsp;Destinations
            </h2>
        </template>
                ...
                >
                    <table class="min-w-full divide-y divide-gray-200 border-separate">
                        ...
                        <tbody>
                            ...
                            >
                                <td
                                    v-if="canEditDestinations"
                                    v-tippy="{ content: 'Click to Edit: <b>' + destination.iata + ' - ' + destination.airport_name + '</b>' }"
                                ...
                                >
                                    <SecondaryButton
                                        ...
                                        @click="confirmDestinationDeletion(destination.id)"
                                    >
                                        <svg
    ...
    <DialogModal
        :show="confirmingDestinationDeletion"
        @close="closeModal"
    >
        <template #title>
        ...
        <template #content>
            <span>Are you sure you want to delete this destination?</span>
        </template>
        <template #footer>
            ...
            <DangerButton @click="deleteDestination">
                YES
            </DangerButton>
        </template>
    </DialogModal>
