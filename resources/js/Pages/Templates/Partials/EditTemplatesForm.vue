...
<template>
    <FormSectionWide>
                ...
                >
                    ...
                    >
                        <img
                            ...
                            :src="$page.props.templates.thumbnail_photo_url"
        ...
        <template #actions>
            <div class="template-edit-form-actions">
                <div class="template-edit-show-fields">
                    <PrimaryButton
                        v-if="canAddFields"
                        @click="toggleFields"
                    >
                ...
                <div class="template-edit-form-buttons">
                    <a
    ...
    <div
        v-show="templateFieldsVisible"
        class="template-fields-container"
    >
    ...
    >
        ...
        <template #content>
            <div class="template-fields-modal-grid">
                <div
                    class="px-2"
                >
                    <InputLabel
