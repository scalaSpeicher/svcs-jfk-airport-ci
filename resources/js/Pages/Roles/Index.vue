    ...
    <AppLayout title="AirPortal JFK Terminal 4">
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                AirPortal JFK Terminal 4&nbsp;|&nbsp;Roles
            </h2>
        </template>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 border-separate">
                        ...
                        <tbody>
                            ...
                            >
                                <td
                                    v-if="canEditRoles"
                                    v-tippy="{ content: 'Click to Edit: ' + role.name.toUpperCase() }"
                                ...
                                <td
                                    v-show="canDeleteRoles"
                                    v-tippy="(
                                        role.name == 'super-admin' ||
                                        role.name == 'user' ||
                                        role.name == '3rd-party-user') ? { content: 'Cannot Delete: ' + role.name.toUpperCase() } : { content: 'Click to Delete: ' + role.name.toUpperCase() }"
                                    class="px-6 py-4 text-sm font-medium text-gray-800 whitespace-nowrap border scala-delete-td"
                                    @click="(
                                        role.name == 'super-admin' ||
                                        role.name == 'user' ||
                                        role.name == '3rd-party-user') ? '' : confirmRoleDeletion(role.id)"
                                >
                                    <SecondaryButton
